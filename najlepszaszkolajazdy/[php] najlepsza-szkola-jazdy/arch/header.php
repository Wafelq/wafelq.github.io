...
<body <?php body_class(); ?>>
    ...
    <header class="main-header">
        <div class="logo"><img src="/assets/img/logo.png" alt="Najlepsza Szkoła Jazdy"></div>
        <nav class="main-nav">
            <ul>
                <li><a href="<?php echo home_url(); ?>">Strona Główna</a></li>
                <li><a href="<?php echo home_url('/about'); ?>">O Nas</a></li>
                <li><a href="<?php echo home_url('/location'); ?>">Miejsce</a></li>
                <li><a href="<?php echo home_url('/schedule'); ?>">Kalendarz</a></li>
                <li><a href="<?php echo home_url('/info'); ?>">Informacje</a></li>
